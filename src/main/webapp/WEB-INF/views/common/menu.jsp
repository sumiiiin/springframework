  ...
  <div class="accordion-item">
    ...
    <div id="collapse12" class="accordion-collapse collapse ${chNum=='ch12'?'show':''}" data-bs-parent="#accordionExample">
      ...
      <ul>
         ...
         <li><a href="${pageContext.request.contextPath}/ch12/createBeanByAnnotation">Annotaion 설정으로 관리 빈 생성</a></li>
         <li><a href="${pageContext.request.contextPath}/ch12/diByXml">XML 설정으로 관리 빈의 의존성 주입(DI)</a></li>
         <li><a href="${pageContext.request.contextPath}/ch12/diByAnnotation">Annotaion 설정으로 관리 빈의 의존성 주입(DI)</a></li>
      </ul>
      </div>
    </div>
  </div>
