...
<title>ajax</title>
      ...
      <script>
      	function requestAjax(){
      		...
      		//var param4 = $("radio:checked").val(); 이걸로 해도 된다.
      		var param4 = $("input[name=param4]:checked").val();
      		var param5 = $("#param5").val();
      		
      		var params = {param1:param1, param2, param3, param4, param5};
      		console.log(params);
				...
				<div class="d-flex row">
					...
					<div class="col-md-8">
						...
						<div class="card">
							...
							<div class="card-body">
								<a href="javascript:requestAjax()" class="btn btn-info btn-sm">AJAX로 비동기 요청 a태그</a> <!-- 누르면 함수 연결 -->
             					<button onclick="requestAjax()" class="btn btn-warning btn-sm">AJAX로 비동기 요청  button태그</button>
								<hr/>
								<form>
